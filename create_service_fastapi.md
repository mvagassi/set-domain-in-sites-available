...
docker run -d --log-driver gelf --log-opt gelf-address=udp://180.131.130.6:5044 --restart always --name fastapi-payment -p 8085:8010 -v /opt/docker/fastapi-payment/config.py:/app/core/config.py -v /opt/docker/fastapi-payment/supervisord.conf:/etc/supervisord.conf -e TZ=Asia/Jakarta registry.msglow.cloud/services/xendit-payment-service/fastapi-payment:<version>
